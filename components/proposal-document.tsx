        ...
        <section id="background" className="mb-16">
          ...
          <Tabs defaultValue="environment" className="mb-8">
            <TabsList className="grid w-full grid-cols-1 md:grid-cols-3">
              ...
              <TabsTrigger value="challenges">人材育成の課題</TabsTrigger>
              <TabsTrigger value="limitations">既存教育の限界</TabsTrigger>
            </TabsList>

            <TabsContent value="environment" className="mt-6">
              <Card>
                <CardContent className="p-6">
                  <h3 className="text-xl font-semibold text-blue-700 mb-4">航空自衛隊を取り巻く環境と任務の変化</h3>
                  <p className="mb-4">
                    我が国を取り巻く安全保障環境は一層厳しさと不確実性を増しており、宇宙・サイバー・電磁波といった新領域における優勢の確保、グレーゾーン事態へのシームレスな対応など、航空自衛隊に求められる役割はますます拡大かつ複雑化しています。
                  </p>
            ...
            <TabsContent value="challenges" className="mt-6">
              <Card>
                <CardContent className="p-6">
                  <h3 className="text-xl font-semibold text-blue-700 mb-4">人材育成における構造的課題</h3>
                  <p className="mb-4">
                    少子化の進行や民間企業との人材獲得競争の激化により、優秀な人材の確保は依然として厳しい状況が続いています。令和6年版防衛白書によれば、自衛官の充足率は長年にわたり
                    <strong>定員を約1割（2万人強）下回る状況</strong>
                    が続いており、この恒常的な人員不足は、部隊の練度維持や任務遂行能力に深刻な影響を及ぼしかねない喫緊の課題です。
              ...
              <Card>
                <CardContent className="p-6">
                  <h3 className="text-xl font-semibold text-blue-700 mb-4">
                    既存教育体系の限界と新たなアプローチの必要性
                  </h3>
                  <p className="mb-4">
                    伝統的に、航空自衛隊の人材育成は、各術科学校等における専門教育と、部隊におけるOJT（On-the-Job
                    Training）を中心に実施されてきました。これらの部内教育は、専門技能の習得や組織文化の継承において不可欠な役割を果たし続けています。
                  </p>

                  <p className="mb-4">
                    しかしながら、特に多くの隊員に共通して求められる
                    <strong>リーダーシップ、コミュニケーション、問題解決といったコモンスキル</strong>や、
                    <strong>変化の速いDX関連スキル</strong>
                    に関しては、既存の教育体系だけでは十分に対応しきれない側面も散見されます。
                  </p>

                  <div className="my-6 bg-white rounded-lg border shadow-sm p-4">
                    <EducatorWorkloadChart />
                    <p className="text-center text-sm text-slate-500 mt-2">
                      図2：教育担当者の業務時間内訳（モデルケース、推定値）
                    </p>
                  </div>

                  <div className="bg-amber-50 rounded-lg border border-amber-200 p-4 my-4">
                    <h4 className="font-semibold text-amber-800 mb-2">教育担当者の現状課題</h4>
                    <p className="text-amber-800 mb-2">
                      教育を担当する中堅隊員が、通常業務に加え、
                      <strong>教育資料の作成、教育場所の確保、参加者の日程調整</strong>
                      といった教育環境の整備業務に多くの時間を費やしている実態があります。
                    </p>
                    <p className="text-amber-800">
                      その結果、教育内容の質の向上や、実施後の効果測定、フィードバックに基づく資料の改善といった、教育効果を高める上で極めて重要なプロセスにまで手が回らず、過去の資料を更新しないまま
                      <strong>踏襲的に教育を実施</strong>
                      するに留まり、「とりあえず実施した」という形式的なものに陥ってしまうケースも少なくありません。
                    </p>
                  </div>

                  <p>
                    このような状況は、教育を受ける側の隊員にとっても、時間的制約の中で必ずしも質の高い、あるいは最新の知識・スキルを習得できる機会とは言えず、
                    <strong>学習意欲の低下を招く可能性</strong>
                    も懸念されます。また、個々の隊員のキャリアパスや関心に応じた
                    <strong>多様な学習ニーズに、きめ細かく応えることも困難</strong>です。
                  </p>
                  ...
                  <div className="bg-blue-50 border-l-4 border-blue-400 p-4 mt-6">
                    <p className="text-blue-800 font-medium">
                      したがって、
                      <strong>
                        既存の部内教育を尊重しつつも、それを効果的に補完し、隊員の自律的な学習を促進するための新たなアプローチ
                      </strong>
                      が求められています。
                    </p>
                  </div>
